							...
							<tbody>
								<tr>
											...
											<div class="modal-dialog">
												...
												<div class="modal-content">
													...
													<div class="modal-footer">
														<form class="form-horizontal" style ="float: left; padding: -5px;" method="POST" action="{{ url('/edit-graduate') }}">
															<input type="hidden" name="_token" value="{{ csrf_token() }}">
									...
									<td>
										...
										&emsp; <button type="button" id="search-confirm-del-button" class="btn btn-danger" data-toggle="modal" data-id="{{ $row->studnum }} {{ $row->fname }} {{ $row->mname }} {{ $row->lname }} {{ $row->suffix }}" data-target="#confirm-delete-modal"><i class="fa fa-minus"></i></button>												
									</div>
									</td>
								</tr>
				  	<?php $i=$i+1; ?>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<form class="search-result-btns" method="POST" action="">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
						<input class="getter" type="hidden" name="studnum" value="">
